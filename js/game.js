/* ============================================================
   Live Wire — a retro CRT idle game about plugging in cords.
   Pure vanilla JS, no dependencies.
   Durable saves: localStorage (sync) + IndexedDB (eviction-resistant).
   (Save keys keep the original "cordTycoon" id so existing players
    retain their progress across the rename.)
   ============================================================ */
(() => {
  'use strict';
  ...
  if (el.version) el.version.textContent = `Live Wire v${VERSION}`;
